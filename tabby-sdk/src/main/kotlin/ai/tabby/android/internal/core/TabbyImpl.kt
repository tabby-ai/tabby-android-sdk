...
internal class TabbyImpl(
    ...
    companion object {
        ...
        private const val CHECKOUT_PATH = "api/v2/checkout"
    }
    ...
    override suspend fun createSession(
        ...
        val checkoutBaseUrl = sdkConfig.endpointsFor(payment.currency).checkoutApiBaseUrl
        val checkoutUrl = checkoutBaseUrl.trimEnd('/') + "/$CHECKOUT_PATH"
    ...
    override fun createCheckoutIntent(product: Product): Intent =
